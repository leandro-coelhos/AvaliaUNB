    ...
    with app.app_context():
        ...
        usuarios = [
            Usuario(
                ...
                email_usuario='joao@aluno.unb.br',
                telefone_usuario='(61) 99999-1111',
                matricula_usuario='12345678',
            ...
            Usuario(
                ...
                email_usuario='maria@admin.unb.br',
                telefone_usuario='(61) 99999-2222',
                matricula_usuario='87654321',
            ...
            Usuario(
                ...
                senha_usuario=generate_password_hash('pedro123'),
                fk_codigo_tipo_usuario=1
            ),
        ]
